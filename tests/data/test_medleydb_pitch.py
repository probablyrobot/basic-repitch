...
def test_medleydb_pitch_dataset():
    try:
        MedleyDBPitchDataset()
    except Exception as e:
        raise AssertionError(f"Failed to create MedleyDBPitchDataset: {e}")


class MedleyDBPitchDataset:
    """Mock MedleyDB Pitch dataset for testing."""

    def __init__(self) -> None:
        """Initialize the dataset."""
        self.audio_dir = "audio"
        self.annotation_dir = "annotation"
        self.track_ids = ["AClassicEducation_NightOwl_STEM_08"]
    ...
    def get_annotation_path(self, track_id: str) -> str:
        ...
        """
        return os.path.join(self.annotation_dir, f"{track_id}.csv")
